...
% https://q.uiver.app/?q=
\[\begin{tikzcd}
	{K_0} && {C_0 \times C_1} \\
	\\
	{K_1} && {C_1}
	...
	\arrow[shorten >=6pt, Rightarrow, no head, from=1-3, to=0]
\end{tikzcd}\]

% https://q.uiver.app/?q=
\[\begin{tikzcd}
	{K_0} && {C_0 \times C_1} \\
	& {C_1} \\
	{K_1} && {C_2}
...
% https://q.uiver.app/?q=
\[\begin{tikzcd}
	{K_0} && {K_1} &&&& {C_1} \\
	\\
	{K_1} && {K_2} &&&& {C_2}
	...
	\arrow["{\InducedHomo{J}{K'_1}}"', from=1-3, to=1-7]
	\arrow[""{name=0, anchor=center, inner sep=0}, "{J_1}", curve={height=-30pt}, from=1-1, to=1-7]
	\arrow["{\InducedHomo{P_0}{K'_1}}", from=3-1, to=3-3]
	\arrow["{\InducedHomo{J}{K'_2}}", from=3-3, to=3-7]
	\arrow["{P_1}", from=1-3, to=3-3]
	\arrow[""{name=1, anchor=center, inner sep=0}, "{\InducedHomo{J_1}{K'_1}}"', curve={height=30pt}, from=3-1, to=3-7]
	\arrow[shorten <=5pt, shorten >=5pt, Rightarrow, no head, from=0, to=1-3]
	\arrow[shorten >=5pt, Rightarrow, no head, from=3-3, to=1]
\end{tikzcd}\]

In the above diagram, the top equation is our definition $J_1 = \InducedHomo{J}{K'_1} \circ P_0$, and the bottom equation follows from this definition as well \TODOinline{we may wish to clarify the reader's understanding of $\InducedHomo{J}{K'_2}$, which involves a doubly internal structure}. The left square commutes as part of the definition of $K$ being a geminal category, and the right square commutes because $J[P'_1] = F'_1$ (which was part of our presumption that $J[\InteriorGeminal{K}] = \gamma$). \TODOinline{Make sure this all makes sense.}
