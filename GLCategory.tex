...
For this diagram to commute, it suffices to know that following both paths with the projection $P : \Glob{Z_2} \to \Glob{C'_2}$ commutes. By unwinding definitions, $P \circ \introS \circ \beta = F'_1 \circ H$ while $P \circ \InducedHomo{\beta}{C} \circ \introS = \InducedHomo{H}{C} \circ \introS$. As $H$ is a geminal category homomorphism from $T$ to $C'_1$, these are indeed the same.
