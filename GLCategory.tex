...
\begin{proof}
Suppose given any geminal category $K = \langle K_0, K'_1, K'_2, \ldots; P_0, P'_1, P'_2, \ldots \rangle$ and strict lexfunctor $J : K_0 \to C_0$ such that $J[\InteriorGeminal{K}] = \gamma$. As ever, we will use unprimed names for the global aspects of primed names. \TODO
