...
\end{construction}
\openDetails
Throughout the following, we use our usual conventions for how unprimed names are defined from the corresponding primed names of internal lexcategories and internal lexfunctors. For linguistic convenience, we shall also in the following take $V$ as $\Set$, but it will be clear that the same explicit construction works for any ambient lexcategory $V$.
...
Recall from \magicref{ModalAxiom4Section} that any introspective theory $\langle T, C \rangle$ comes with a $T$-internal endolexfunctor $\Box_C$, along with a $T$-internal natural transformation $4 : \Box_C \to \Box_C \Box_C$ built from $\introN$. From \magicref{BoxCAlternativeDescriptionLemma}, we see that this $\Box_C$ can be defined as the composition of $\introN_C$ and $\Hom_{\introS[C]}(1, -)$.

Interpreting the above in the particular context of the introspective theory $\langle \GLCatTheory, |K| \rangle$ of \magicref{GLCatTheoryIsIntrosp}, we find that any geminal category $C'_1 = \langle C'_1, C'_2; F'_1, F'_2 \rangle$ \TODOinline{Should make $C_1$ into $C'_1$ throughout} comes with an endolexfunctor $\Box_{C'_1} = \Gamma_{C'_2} \circ F'_1: C'_1 \to C'_1$, along with a natural transformation $4 : \Box_{C'_1} \to \Box_{C'_1} \Box_{C'_1}$ corresponding to the action of $F'_2$.
...
By construction, the projection functor $\pi : Z \to C'_1$, which sends coalgebras to their carriers, is a strict lexfunctor which takes $Z_2$ to $C'_2$ and takes $\introN_{Z_2}$ to $F'_2$, while furthermore the following diagram commutes:
...
This establishes $\pi$ as a geminal category homomorphism from $Z$ to $C'_1$.

\closeDetails

Having described the strict introspective theory $Z$ and its geminal category homomorphism $\pi$ to $C'_1$, we now prove its terminality among all strict introspective theories with a designated geminal category homomorphism to $C'_1$:
...
% https://q.uiver.app/#q=
\[\begin{tikzcd}
	T &&& {C_1} \\
	{\Glob{C}} &&& {\Glob{C'_2}} \\
	T &&& {C_1}
...
% https://q.uiver.app/#q=
\[\begin{tikzcd}
	T &&&& {C_1} \\
	& {\Glob{C}} &&& {\Glob{C'_2}} \\
	T &&&& {C_1}
