...
\begin{construction}
For any lexcategory $C_0$ with an internal geminal category $\gamma$, there is a terminal geminal category $G$ equipped with a lexfunctor $H : \underlying{G} \to C_0$ such that $H[\InteriorGeminal{G}] = \gamma$. This co-free $G$ admits a tractable explicit description as $C_0 \times \underlying{\gamma}$ suitably equipped.
\end{construction}
\openDetails
