...
Let $C_1 = \langle C_1, C'_2; F_1, F'_2 \rangle$ be a geminal category. Let us use the suggestive name $\Box_{C_1}$ for the endolexfunctor $\Gamma_{C'_2} \circ F_1 : C_1 \to C_1$. Via \magicref{BoxCoalgebrasInGeminal}, the category of $\Box_{C_1}$-coalgebras is a strict lexcategory.

Among these $\Box_{C_1}$-coalgebras, there are some coalgebras $m : c \to \Box_{C_1} c$ with the property that the following diagram commutes:
...
It is readily verified that $K$ is closed under the chosen basic limits of $\Box_{C_1}$ \TODOinline{As an equalizer between strict lexfunctors}, and thus $K$ can be seen as a full sub-strict-lexcategory of the $\Box_{C_1}$ coalgebras.
