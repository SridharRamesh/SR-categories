...
\sTODOinline{Rewrite this just in terms of the internal $\Box_C$ in the initial introspective theory, which then automatically applies to arbitrary geminal categories. Also discuss how \Loeb/'s theorem holds in any geminal category.}

\TODOinline{Discuss how every geminal category inherits a box operator modelling the GL modal logic, from the $\Box_C$ operator in the introspective theory of geminal categories.}
