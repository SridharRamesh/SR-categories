...
Thus, all presumptions are satisfied for us to be able to apply \magicref{PreIntrospDiag} for an arbitrary $g : \introS(\Omega) \to P$. Such a $g$ amounts to \TODO
