...
Now consider what $\pullAlong{\introN_{X}(x)} F'$ comes out to. By the definition of $F'$, this is $\pullAlong{\introN_{X}(x)} \pullAlong{\introS(F)} j$.
