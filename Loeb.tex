...
Now suppose given some $T$-\repsmall/ object $\Omega$ with a map $quotient : \Omega \to P(1)$ such that $quotient$ is surjective on the $X \times X$ aspect. Furthermore, let us suppose we have some $j$ in the global aspect of $P(\introS(\Omega))$. (Note that $\introS(\Omega)$ is well-defined because $\Omega$ is $T$-\repsmall/).
