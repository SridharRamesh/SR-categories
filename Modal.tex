...
The $\Box$ operators on \magicref{StepIndexingIntrosp} are again essentially the same as those on \magicref{StepIndexingLocallyIntrosp}, as the former is given by sub-introspection of the latter \TODOinline{Again, discuss how sub-introspections relate to the $\Box$ operators}.
