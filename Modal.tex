...
Note that the category of locally $T$-small presheaves on $C$ is itself a $T$-indexed lexcategory. We will refer to this as $\Psh{C}$. \TODOinline{Clarify in detail what the objects and morphisms of each aspect of this $T$-indexed category are? Basically, both $C$ and the self-indexing $T/-$ exist as categories internal to the topos $\Set^{\op{T}}$, and thus so does the contravariant functor category from the former to the latter.}
