...
Recall from \magicref{PreliminariesMultipleIndexing} the $T$-indexed category $\Psh{C}$ (the appropriate notion of the category of presheaves on $C$ when $C$ is an indexed category rather than a category simpliciter).
