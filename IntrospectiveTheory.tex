...
% Note that it's the right adjoint of $\Sigma$ which is of importance, but that this acts as the left adjoint of $\op{Sigma}$, the latter being the functor that actually appears in the diagram above.
