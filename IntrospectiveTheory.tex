...
\begin{construction}\label{FullSubIntrosp}
When a pre-introspective theory $\langle S, D, G \rangle$ is obtained from a pre-introspective theory $\langle T, C, \introF \rangle$ by the combination of \magicref{SubPreIntrosp} and \magicref{SubCPreIntrosp} as illustrated below, we say that $\langle S, D, G \rangle$ is a \defined{sub-introspection} of $\langle T, C, \introF \rangle$.
