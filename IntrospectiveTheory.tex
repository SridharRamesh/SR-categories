...
\TODOinline{Some note somewhere about how we will not generally be explicit about noting distinctions between $\introS(a \times b)$ and $\introS(a) \times \introS(b)$, etc., but shall write with the ordinary fluency for working with lexfunctors}
