...
Note that the category of locally-$T$-small presheaves on $C$ is itself a $T$-indexed lexcategory. We will refer to this as $\Psh{C}$. \TODOinline{Expand on this. Actually, in the following, all we mostly need is that $P(1)$ is $T$-small, although we occasionally make use of more when exponentiating presheaves.}
