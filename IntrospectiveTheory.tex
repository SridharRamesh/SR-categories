...
Alas, this simple example of a pre-introspective theory is almost never an introspective theory (that is to say, a lexcategory's self-indexing is almost never small). We will give an archetypal example of an introspective theory soon enough, but let us first develop some further machinery on how pre-introspective theories may be presented.
...
\TODOinline{Give a very quick example of an introspective theory, or a link to the sigma-1 example from the Models chapter}
