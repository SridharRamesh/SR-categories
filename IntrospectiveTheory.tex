...
\bigskip
\TODOinline{We use the following construction only once, at \magicref{Sigma1ModelIAUConnection}. It also calls upon the notion of introspective theory homomorphism from \magicref{StrictIntrospHomoDefn}. It should thus be moved to later in the document.}
