...
The functor $\mathrm{Successor} : n : \omega \mapsto n + 1 : \omega$ induces correspondingly a functor $\pullAlong{\mathrm{Successor}} : \Psh{\omega} \to \Psh{\omega}$. For convenience, we will use the name $\Prior$ rather than $\pullAlong{\mathrm{Successor}}$ to refer to this endofunctor on $\Psh{\omega}$. Thus, $\Prior(P)(n) = P(n + 1)$ for $n \in \omega$.
