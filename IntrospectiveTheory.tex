...
We can consider presheaves on $P$, which comprise $\Psh{P}$, and we can consider presheaves on $|P|$, which comprise $\Psh{|P|}$. The inclusion functor $|P| \to P$ gives us a forgetful functor $\Psh{P} \to \Psh{|P|}$. Because limits in presheaf categories are computed componentwise, this forgetful functor is a lexfunctor.
...
\subsection{Basic constructions of (pre-)introspective theories}
