...
\end{lemma}
\begin{proof}
This is straightforward. If $T$ already has a terminal object, then $T$ is the same as $T$ freely augmented with a new object, a cone from all of $T$ to the new object, and then freely making the cone map from the old terminal object to the new terminal object an isomorphism. We can then see what functor categories out of this amount to. \TODO
\end{proof}
...
\beginMathNamed{lemma}{$\introS$ Matches $\introN$}{S Matches N}\label{SMatchesN}
