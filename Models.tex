...
\TODOinline{Improve notation throughout the following.}
...
From the above, we have a pre-introspective theory $\langle \KPshGlobal{K_S}{S}, C, \introF \rangle$ in which $\introF$ is given by the composite 2-cell in the following diagram, with the $\KPshGlobal{K_S}{S}$-indexed lexcategory $C$ as the codomain of this 2-cell:
...
Under suitable conditions on the ramp, the pre-introspective theory described in \magicref{CardinalityConstrainedPresheafIntrosp} is in fact an introspective theory. This happens precisely if \TODO.
