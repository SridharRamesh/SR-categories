...
\end{theorem}
\begin{proof}
This is the instance of \magicref{CommaKanStrongSigmesque} where we take $D$ to be $\LexCat$, with $Special$ as the sub-2-category $\initMod{T}$.

The preconditions for invoking \magicref{CommaKanStrongSigmesque} are satisfied in this context via \magicref{InitialModelCommaStable}.
\end{proof}
...
\end{theorem}
\begin{proof}
This is the instance of \magicref{CommaKanStrongSigmesque} where we take $D$ to be $\LexCat$, with the special $0$-cells as the arithmetic universes and the special $1$-cells as the arithmetic functors. The preconditions for invoking \magicref{CommaKanStrongSigmesque} are satisfied in this context via \magicref{CommaStableArithmetic}.
\end{proof}
