...
In the above diagram, unlabelled arrows are canonical inclusions of full sublexcategories. In particular, the unlabelled right 2-cell is the way in which $\KPshGlobal{K_D}{D}$ is an indexed full sublexcategory of $\KFiberPsh{K_D}{D}$ \TODOinline{Why?}.
