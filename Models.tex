...
% https://q.uiver.app/?q=
\[\begin{tikzcd}
	{\op{\Psh{S}}} &&&&& \LexCat \\
	{\op{\Prior}} &&& {\op{\Psh{D}}}
	\arrow["{\op{\left( \pullAlong{i} \right)}}"{description}, from=1-1, to=2-4]
	\arrow["{\Psh{D}/-}"', from=2-4, to=1-6]
	\arrow[""{name=0, anchor=center, inner sep=0}, "{\Psh{S}/-}", from=1-1, to=1-6]
	\arrow[curve={height=12pt}, no head, from=1-1, to=2-1]
	\arrow[curve={height=12pt}, from=2-1, to=1-1]
	\arrow[Rightarrow, from=1-1, to=2-1]
	\arrow["{\pullAlong{i}}"{description}, shorten <=4pt, Rightarrow, from=0, to=2-4]
\end{tikzcd}\]
...
\TODOinline{Explain how the following is all about cardinality constraints, in terms of fibers}

Let $X$ be a category internal to $\Set$, and let $K$ be a function from the objects of $X$ to sets of sets. We call any choice of such $K$ a \quote{ramp} on $X$.
...
\TODOinline{Probe $\KFiberPsh{K}{X}$ with representable preseheaves, to observe that its $x$-aspect only depends on $K$ at objects $\leq x$.}
